...
public partial class TempleMP_Form_Estudiante : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        if (TNombre.Text == "")
        {
            ...
            Response.Redirect("Form_Estudiante.aspx");
    ...
    {
        TNombre.Text = ds.Tables[0].Rows[0]["NombreProfesor"].ToString();
        TApellido.Text = ds.Tables[0].Rows[0]["ApellidoProfesor"].ToString();
